...
auto error_for_extrinsics(const std::vector<CalibRecord>& recs, GuidanceConfig cfg) -> float {
...
auto optimize_extrinsics(const std::vector<CalibRecord>& recs, GuidanceConfig init)
    -> GuidanceConfig {
...
int main(int argc, char** argv) {
    ...
    std::println(
        "Initial: t=({:.1f},{:.1f},{:.1f})mm r=({:.2f},{:.2f},{:.2f})° err={:.3f}°", init.t_x_mm,
        init.t_y_mm, init.t_z_mm, init.r_x_deg, init.r_y_deg, init.r_z_deg,
