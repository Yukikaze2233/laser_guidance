...
inline auto pixel_format_name(const rmcs_laser_guidance::V4l2PixelFormat pixel_format) noexcept
    -> const char* {
    switch (pixel_format) {
    case rmcs_laser_guidance::V4l2PixelFormat::mjpeg: return "mjpeg";
    case rmcs_laser_guidance::V4l2PixelFormat::yuyv: return "yuyv";
    case rmcs_laser_guidance::V4l2PixelFormat::bgr24: return "bgr24";
...
inline auto inference_backend_name(const rmcs_laser_guidance::InferenceBackendKind backend) noexcept
    -> const char* {
    switch (backend) {
    case rmcs_laser_guidance::InferenceBackendKind::bright_spot: return "bright_spot";
    case rmcs_laser_guidance::InferenceBackendKind::model: return "model";
    default: return "unknown";
    }
}
