...
int main() {
    try {
        ...
        require(
            default_config.v4l2.device_path
                == std::filesystem::path(
                    "/dev/v4l/by-id/"
                    "usb-UGREEN_UGREEN_95348_20250910-video-index0"),
        ...
        require_near(
            static_cast<float>(default_record_options.duration_seconds), 60.0F, 1e-3F,
            "default record duration mismatch");
        require(
            default_record_options.lighting_tag == "unspecified",
            "default record lighting tag mismatch");
        require(
            default_record_options.background_tag == "unspecified",
            "default record background tag mismatch");
        require(
            default_record_options.distance_tag == "unspecified",
        ...
        require(
            capture_profile.v4l2.device_path
                == std::filesystem::path(
                    "/dev/v4l/by-id/"
                    "usb-UGREEN_UGREEN_95348_20250910-video-index0"),
        ...
        require(
            capture_profile.v4l2.pixel_format == rmcs_laser_guidance::V4l2PixelFormat::mjpeg,
        ...
        require(
            capture_record_options.background_tag == "plain_wall",
        ...
        require(
            override_config.runtime.max_input_age_ms == 10, "override max_input_age_ms mismatch");
        require(
            override_config.runtime.max_observation_age_ms == 20,
            "override max_observation_age_ms mismatch");
        require(override_config.runtime.max_infer_fps == 120, "override max_infer_fps mismatch");
        require(override_config.runtime.warmup_frames == 5, "override warmup_frames mismatch");
        require(
            override_config.runtime.engine_path == std::filesystem::path("/tmp/model.engine"),
            "override engine_path mismatch");
        require(
            override_config.runtime.hit_confirm_frames == 7,
            "override hit_confirm_frames mismatch");
        require(
            override_config.runtime.hit_release_frames == 9,
        ...
        require(
            override_config.runtime.record_queue_size == 8, "override record_queue_size mismatch");
        require(
