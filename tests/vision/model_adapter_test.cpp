...
int main() {
    try {
        ...
        const auto three_class_raw_result = rmcs_laser_guidance::adapt_yolo_outputs(
            frame, rmcs_laser_guidance::ModelRunResult{
                       .success = true,
                       .message = {},
        ...
        require(
            empty_output_result.contract_supported,
            "empty output result should still support the contract");
        require(!empty_output_result.observation.detected, "empty output result should not detect");

        const auto shape_mismatch_result = rmcs_laser_guidance::adapt_yolo_outputs(
            frame, rmcs_laser_guidance::ModelRunResult{
                       .success = true,
                       .message = {},
                       .transform = identity_transform(),
        ...
        require(!shape_mismatch_result.success, "shape mismatch result should fail explicitly");
        require(
            !shape_mismatch_result.contract_supported,
            "shape mismatch result should not support the contract");
        require_contains(
            shape_mismatch_result.message, "model output contract is unsupported",
            "shape mismatch failure reason");
        require_contains(
            shape_mismatch_result.message, "last_dim=5", "shape mismatch last dimension");

        const auto raw_result = rmcs_laser_guidance::adapt_yolo_outputs(
            frame, rmcs_laser_guidance::ModelRunResult{
                       .success = true,
                       .message = {},
                       .transform = identity_transform(),
        ...
        const auto nms_result = rmcs_laser_guidance::adapt_yolo_outputs(
            frame, rmcs_laser_guidance::ModelRunResult{
                       .success = true,
                       .message = {},
                       .transform = identity_transform(),
        ...
        const auto split_nms_result = rmcs_laser_guidance::adapt_yolo_outputs(
            frame, rmcs_laser_guidance::ModelRunResult{
                       .success = true,
                       .message = {},
                       .transform = identity_transform(),
        ...
        const auto unsupported_result = rmcs_laser_guidance::adapt_yolo_outputs(
            frame, rmcs_laser_guidance::ModelRunResult{
                       .success = true,
                       .message = {},
                       .transform = identity_transform(),
        ...
        require(
            !unsupported_result.contract_supported,
