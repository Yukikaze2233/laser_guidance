...
static inline cudaError_t
    cudaMemcpyAsync(void* dst, const void* src, std::size_t count, cudaMemcpyKind, cudaStream_t) {
...
static inline const char* cudaGetErrorString(cudaError_t error) {
    ...
    case 1: return "cudaInvalidValue";
    case 2: return "cudaMemoryAllocation";
    default: return "cudaError";
    }
}
