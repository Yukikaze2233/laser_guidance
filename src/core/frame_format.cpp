...
auto detect_frame_format(const cv::Mat& image) noexcept -> FrameFormat {
    ...
    case 1: return FrameFormat::gray8;
    case 3: return FrameFormat::bgr8;
    case 4: return FrameFormat::bgra8;
    default: return FrameFormat::unknown;
    }
}
...
auto to_gray_image(const cv::Mat& image) -> cv::Mat {
    ...
    case FrameFormat::gray8: gray = image.clone(); break;
    case FrameFormat::bgr8: cv::cvtColor(image, gray, cv::COLOR_BGR2GRAY); break;
    case FrameFormat::bgra8: cv::cvtColor(image, gray, cv::COLOR_BGRA2GRAY); break;
    default: break;
    }
